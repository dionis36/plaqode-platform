...
export function AppStorePreview({ data }: { data: any }) {
    ...
    const platformBadges = {
        google_play: {
            name: 'Google Play',
            badge: (
                <div className="w-full bg-black rounded-xl py-3.5 px-6 flex items-center justify-center gap-3 transition-colors">
                    ...
                    <div className="space-y-3 pt-1">
                        {platforms.map((platform: any, index: number) => (
                            <a
                                ...
                                className="block cursor-pointer transform active:scale-[0.98] transition-transform"
                            >
