...
function DesignPageContent({ params }: { params: { template: string } }) {
    ...
    return (
        <div className="w-full px-4 pb-20">
            <h1 className="text-3xl font-bold mb-8 text-center text-purple-600">🐞 DEBUG MODE: Replica</h1>
...
export default function DesignReplicaPage() {
    // Hardcode params for replica logic
    const params = { template: 'url' };
    return (
        <Suspense fallback={
            ...
            <DesignPageContent params={params} />
        </Suspense>
    );
}
