...
function UrlQrPageContent() {
    const { payload, setEditMode, loadQrData } = useWizardStore();
    const { isValid } = useTemplateValidation('url');
    ...
    return (
        <div className="w-full px-3 sm:px-6 pb-20">
            <h1 className="text-3xl font-bold mb-8 text-center text-purple-600">🐞 DEBUG MODE: Template Replica</h1>
            <SEO
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="w-full lg:w-3/4 flex flex-col">
                    ...
                    <div className="mt-8 pt-6 border-t border-slate-100 flex justify-end">
                        <button
                            onClick={() => router.push(`/debug/design-replica${editId ? `?edit=${editId}` : ''}`)}
                            disabled={!isValid}
...
export default function TemplateReplicaPage() {
    return (
        <Suspense fallback={
            <div className="w-full px-4 pb-20 flex items-center justify-center min-h-[400px]">
                <div className="text-center">
