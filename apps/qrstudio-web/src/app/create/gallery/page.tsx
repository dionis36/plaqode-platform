...
import { GalleryForm } from '@/components/wizard/forms/GalleryForm';
import { PhoneMockup } from '@/components/common/PhoneMockup';
import { GalleryPreview } from '@/components/wizard/preview/GalleryPreview';
...
function GalleryPageContent() {
    ...
    // Validation: Require at least one image in the gallery
    const localIsValid = !!(payload.gallery?.images && payload.gallery.images.length > 0);
    ...
    const handleNext = () => {
        router.push(`/create/gallery/design${editId ? `?edit=${editId}` : ''}`);
    };
    ...
    return (
        ...
        >
            <div className="w-full px-3 sm:px-6 pb-20">
                <SEO
                    title="Create Image Gallery QR"
                    description="Share a collection of images in a beautiful gallery"
                />
