...
import { VideoForm } from '@/components/wizard/forms/VideoForm';
import { PhoneMockup } from '@/components/common/PhoneMockup';
import { VideoPreview } from '@/components/wizard/preview/VideoPreview';
...
function VideoPageContent() {
    ...
    const handleNext = () => {
        router.push(`/create/video/design${editId ? `?edit=${editId}` : ''}`);
    };
        ...
        >
            <div className="w-full px-3 sm:px-6 pb-20">
                <SEO
                    ...
                    description="Share YouTube. Vimeo, or custom videos instantly"
                />
