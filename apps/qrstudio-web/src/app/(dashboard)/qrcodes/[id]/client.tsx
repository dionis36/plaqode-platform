...
import { ArrowLeft, Download, ExternalLink, Copy, Edit, Trash2, Smartphone, BarChart3, QrCode as QrCodeIcon, Globe } from 'lucide-react';
...
export function QrPageClient({ id }: QrPageClientProps) {
    ...
    const baseUrl = process.env.NEXT_PUBLIC_PLATFORM_URL || (typeof window !== 'undefined' ? window.location.origin : 'https://plaqode.com');
