                ...
                <div className="w-full max-w-md px-8 py-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 bg-black text-white rounded-2xl font-bold font-sans hover:opacity-80 transition-all duration-300 disabled:opacity-50 shadow-lg shadow-black/10 mt-4 flex items-center justify-center gap-2"
                        >
                            {loading ? <UniversalLoader size="sm" variant="button" /> : 'Create Account'}
                        </button>
