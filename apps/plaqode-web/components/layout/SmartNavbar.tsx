...
export default function SmartNavbar() {
    ...
    return (
        <>
            <header
                className={`fixed top-0 left-0 w-full z-[999] bg-[#121212]/90 backdrop-blur-xl shadow-md border-b border-white/5 rounded-b-lg transition-transform duration-300 ease-in-out ${isVisible ? "translate-y-0" : "-translate-y-full"
                    }`}
            >
