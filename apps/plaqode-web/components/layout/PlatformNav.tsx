        ...
        <header className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-sm border-b border-gray-800">
            <nav className="container mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-8">
                    <a
                        href="/"
                        className={`transition ${isActive('/') ? 'text-purple-400' : 'text-white hover:text-purple-400'}`}
                    >
                        Home
                    </a>
                    <a
                        href="/about"
                        className={`transition ${isActive('/about') ? 'text-purple-400' : 'text-white hover:text-purple-400'}`}
                    >
                        About
                    </a>
                    <a
                        href="/services"
                        className={`transition ${isActive('/services') ? 'text-purple-400' : 'text-white hover:text-purple-400'}`}
                    >
                        Services
                    </a>
                    <a
                        href="/contact"
                        className={`transition ${isActive('/contact') ? 'text-purple-400' : 'text-white hover:text-purple-400'}`}
                    >
                        Contact
                    </a>
