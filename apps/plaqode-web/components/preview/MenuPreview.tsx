...
export function MenuPreview({ data }: { data: MenuData }) {
    const fallback = {
        restaurant_info: {
            name: "Mama's Kitchen",
            description: 'Authentic cuisine & local favorites',
            ...
            categories: [
                {
                    ...
                    name: 'Starters',
                    items: [
                        { id: '1', name: 'Garlic Bread', description: 'Freshly baked', price: 5.00, currency: 'USD' as const, available: true }
                    ]
                }
            ]
        },
    ...
    // Logic to gracefully handle fallback for top-level info
    const info = {
