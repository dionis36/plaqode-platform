...
export function VCardPreview({ data }: { data: any }) {
    ...
    const socialNetworks = activeData?.social_networks || [];
    ...
    // const companyName = company.company_name; // Unused in original code block I read, but present in object
    ...
    const lightenColor = (hex: string, percent: number = 90) => {
        ...
        try {
            ...
            return `#${((rC << 16) | (gC << 8) | bC).toString(16).padStart(6, '0')}`;
        } catch (e) { return hex; }
    };

    return (
        <div
            className="flex-1 w-full h-full flex flex-col overflow-y-auto relative"
            style={{
        ...
        >
            ...
            >
                ...
                <button
                    ...
                    onClick={() => {
                        alert("Save Contact feature coming soon!");
                    }}
                >
                    Save Contact
                </button>
