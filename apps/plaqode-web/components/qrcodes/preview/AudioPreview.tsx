            ...
            <div className="relative w-full h-full overflow-y-auto no-scrollbar flex flex-col z-10">
                ...
                <div className="flex-none flex flex-col justify-center items-center pb-8 px-6 text-center">
                    ...
                    <div className="relative group mb-8">
                        ...
                        {/* Squircle Image */}
                        <div
                            className={`relative w-72 h-72 rounded-[3rem] shadow-2xl overflow-hidden border-4 border-white/40 ring-4 ring-black/5 transition-transform duration-700 ease-out rotate-2 ${isPlaying ? 'scale-105' : 'scale-100'}`}
